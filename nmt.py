...
from CharacterToBits_Representation import GB
...
def init_params(options):
    ...
    # embedding
    newMatrix = numpy.array(GB)
    params['Wemb'] = newMatrix.astype('float32')
   # params['Wemb'] = norm_weight(options['n_words_src'], options['dim_word']) #genera los embering rntrada,25 aleatoria
...
def train(dim_word=100,  # word vector dimensionality
          ...
          datasets=[
              '/veu4/usuaris29/mruiz/tfg-imagenes/train/train.un.ch.zh',   
              '/veu4/usuaris29/mruiz/tfg-imagenes/train/train.un.es'],  
          valid_datasets=['/veu4/usuaris29/mruiz/tfg-imagenes/dev/dev.un.ch.zh', 
                          '/veu4/usuaris29/mruiz/tfg-imagenes/dev/dev.un.es'], 
          dictionaries=[
              '/veu4/usuaris29/mruiz/tfg-imagenes/train/vocab.ch.zh.pk',  
